...
public interface DataRoleAddressMapper extends AbstractMapper<DataRoleAddress>{
    ...
    public List<Map<String,String>> getProvinceInfoWithDataRuleByCondition(@Param("userId")long userId,@Param("equipmentVariety")String equipmentVariety,@Param("useTime")String useTime,@Param("startValue") float startValue,@Param("endValue")float endValue);
}
