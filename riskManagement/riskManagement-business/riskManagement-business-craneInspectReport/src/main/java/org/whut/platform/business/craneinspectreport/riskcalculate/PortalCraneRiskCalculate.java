...
public class PortalCraneRiskCalculate implements ICalculateRisk{
    ...
    public Float calculateRisk(CraneInspectReport craneInspectReport,String craneType){
        ...
        //不同的元素
        Float P7=craneInspectReport.getRange()*WeightFactor.constant/transferMaxValueToFloat(d,WeightFactor.maxRange);
        Float P8=craneInspectReport.getRunSpeed()*WeightFactor.constant/transferMaxValueToFloat(d,WeightFactor.maxRunSpeed);
        Float P9=craneInspectReport.getMaxLiftMoment()*WeightFactor.constant/transferMaxValueToFloat(d,WeightFactor.maxLiftMoment);
